...
Current health-model direction for consumer services:
...
The harness should assume `process` by default when the service contract does not override the health model, and should then execute the service-declared alternative when present.
